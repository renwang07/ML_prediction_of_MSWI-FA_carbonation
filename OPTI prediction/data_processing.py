...
def scaler_data_processing(file):
    ...
    raw_training_feature_value, raw_test_feature_value, raw_training_target_value, raw_test_target_value = train_test_split(
        raw_feature_value, target_value,
    ...
    return (training_feature_value, training_target_value, test_feature_value, test_target_value, raw_feature_train_summary,
            data_df, raw_training_feature_value, raw_training_target_value, raw_test_feature_value, raw_test_target_value)